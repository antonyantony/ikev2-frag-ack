...
order to avoid unnecessary traffic and message processing overhead and
to remain consistent with the sender-driven retransmission model of
IKEv2. However, with large number of fragments this may take long
time to converge.
